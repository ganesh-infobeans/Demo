 ...
 * @var array
 */
	public $helpers = array('TextHighlight');
 ...
 */
	public function add() {
		if ($this->request->is('post')) {
			if ($this->Department->saveDepartment($this->request->data)) {
                                $this->CustomEmail->to      =  Configure::read('admin_email');
                                $this->CustomEmail->subject =  "New Department added ";
                                $this->CustomEmail->body    =  "New department has been added  ";
                                $this->CustomEmail->type    =  "PHP";
                                $this->CustomEmail->sendmail();
